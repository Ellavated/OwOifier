...
class myLogger extends Logger.class
{
    ...
    log() {
        ...
        const msg = this.formatNoColor("LOG", args);
        this.append(msg);
        super.log(...args);
        return this;
    }
	...
	{
		const args = Array.prototype.slice.call(arguments);
		const msg = this.formatNoColor("DEBUG", args);
		this.append(msg);
		super.debug(...args);
		return this;
	}
	...
	{
		const args = Array.prototype.slice.call(arguments);
		const msg = this.formatNoColor("INFO", args);
		this.append(msg);
		super.info(...args);
		return this;
	}
	...
	{
		const args = Array.prototype.slice.call(arguments);
		const msg = this.formatNoColor("ALERT", args);
		this.append(msg);
		super.alert(...args);
		return this;
	}
	...
	{
		const args = Array.prototype.slice.call(arguments);
		const msg = this.formatNoColor("SUCC", args);
		this.append(msg);
		super.success(...args);
		return this;
	}
	...
	{
		const args = Array.prototype.slice.call(arguments);
		const msg = this.formatNoColor("WARN", args);
		this.append(msg);
		super.warning(...args);
		return this;
	}
